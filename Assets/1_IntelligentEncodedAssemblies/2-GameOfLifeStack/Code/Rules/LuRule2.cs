...
namespace RC3
{
    namespace GameOfLifeStack
    {
        ...
        public class LuRule2 : MonoBehaviour, ICARule2D
        {
            ...
            private void GetMeanStackDensity()
            {
                meanDensityText.text ="Mean Density :" + _analyser.MeanStackDensity.ToString( );
